...
inline bool asfasfasffasfas = false;
inline bool fast_bow_checkbox = false;
inline bool Fast_Compound_Checkbox = false;
...
inline bool walkonwater_checkboxx = false;
inline float gravity_distancee = 1;
